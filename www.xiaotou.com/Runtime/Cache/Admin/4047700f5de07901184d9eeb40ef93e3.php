...
<body>
	...
	<div class="cf">
		<div class="fl">
			<a class="btn" href="<?php echo U('Caiji/addJiedian');?>">新 增</a>
            <button class="btn ajax-post" target-form="ids" url="<?php echo U("Caiji/setStatus",array("status"=>1));?>">启 用</button>
			<button class="btn ajax-post" target-form="ids" url="<?php echo U("Caiji/setStatus",array("status"=>0));?>">禁 用</button>
		</div>
		...
		<table>
            ...
            <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php echo default_rule($data['id']);?></td>
